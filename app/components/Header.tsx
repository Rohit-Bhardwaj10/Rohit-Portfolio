...
export default function Header() {
  ...
  return (
    <motion.header 
      className="border-b border-white/10 mb-0 bg-[#050505]/70 backdrop-blur-xl sticky top-0 z-50 transition-all duration-300"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <FadeIn delay={0.1} duration={0.5}>
        <div className="flex justify-between items-center py-2 border-b border-white/5 text-[9px] md:text-[10px] font-sans font-bold uppercase tracking-[0.3em] text-zinc-500 px-4 md:px-8">
