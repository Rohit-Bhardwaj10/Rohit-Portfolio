      ...
      <div className="p-4 md:p-6 space-y-6 md:space-y-8 pr-2 md:pr-4">
        {projects.map((project, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8, ease: [0.19, 1, 0.22, 1], delay: index * 0.07 }}
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div className="space-y-1">
                ...
                <p className="font-serif italic text-sm text-zinc-400">Personal Project</p>
              </div>
              <div className="flex flex-col items-end gap-1">
                <span className="font-mono text-[11px] text-zinc-300 bg-zinc-800 px-2 py-0.5 rounded-sm font-black uppercase tracking-tighter">{project.year}</span>
                <div className="flex items-center gap-2">
                  ...
                  {project.link && project.link !== "#" && (
                    <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-zinc-200 transition-colors">
            ...
            <div className="pl-6 border-l border-solid border-white/10 group-hover/item:border-white/30 transition-all duration-500 relative">
              <motion.div
                ...
                transition={{ duration: 1.5, ease: "circOut", delay: 0.2 + index * 0.07 }}
                viewport={{ once: true }}
              />
